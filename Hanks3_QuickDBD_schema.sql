...
CREATE TABLE "hanks_OMDB" (
    ...
    CONSTRAINT "pk_hanks_OMDB" PRIMARY KEY (
        "Title"
     )
);
...
ALTER TABLE "hanks_survey" ADD CONSTRAINT "fk_hanks_survey_Movie_Selection_1" FOREIGN KEY("Movie_Selection_1")
REFERENCES "hanks_OMDB" ("Title");
